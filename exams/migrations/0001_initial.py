# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2017-12-30 08:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(default=datetime.datetime(2017, 12, 30, 8, 16, 28, 384000, tzinfo=utc), verbose_name='create time')),
                ('exam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='exams.Exam', verbose_name='exam')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(default=datetime.datetime(2017, 12, 30, 8, 16, 28, 381000, tzinfo=utc), verbose_name='create time')),
            ],
            options={
